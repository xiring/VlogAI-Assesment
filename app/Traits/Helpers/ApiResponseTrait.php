...
trait ApiResponseTrait
{
    ...
    protected function respondNoContentResource($message = 'No Content Found'): JsonResponse
    {
    ...
    protected function respondNoContentResourceCollection($message = 'No Content Found'): JsonResponse
    {
